...
```bash
git clone --branch v$VERSION https://github.com/btcpayserver/NBXplorer && cd NBXplorer
```
...
<pre class="language-bash" data-overflow="wrap"><code class="lang-bash"><strong>git pull https://github.com/btcpayserver/NBXplorer v$VERSION
</strong></code></pre>
