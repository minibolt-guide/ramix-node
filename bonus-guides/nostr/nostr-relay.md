...
{% hint style="info" %}
If you want, use the same [`favicon.ico`](https://raw.githubusercontent.com/minibolt-guide/minibolt/nostr-relay-PR/resources/favicon.ico) file downloaded before (the relay's icon of RaMiX) and the value `relay_icon` parameter (URL -> [https://blossom.minibolt.info/35cb7871786875878269f04faafd3be8b5a536b9c4ce5f4bbbf82742873bc222.png](https://blossom.minibolt.info/35cb7871786875878269f04faafd3be8b5a536b9c4ce5f4bbbf82742873bc222.png)), or replace it with your info
{% endhint %}
