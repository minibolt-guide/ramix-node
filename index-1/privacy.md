...
<div align="left"><img src="../.gitbook/assets/i2p-logo.png" alt="" width="150"></div>
...
Also, you can use the Tor proxy connection to reach clearnet or a third-party address connection on the Sparrow wallet. Check out the [Desktop signing app: Sparrow Wallet](../bitcoin/bitcoin/desktop-signing-app-sparrow.md) guide to get instructions.
{% endhint %}
...
{% hint style="danger" %}
ATTENTION!!! Do not proceed to the [next Uninstall section](privacy.md#uninstall) if you **do not wish to uninstall**. Skip directly to the [Bitcoin client](../bitcoin/bitcoin/bitcoin-client.md) section
{% endhint %}
...
![](../.gitbook/assets/i2p-failing.png)
